...
/* harmony import */ var _components_scriptloaders_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/scriptloaders.js */ "./src/js/components/scriptloaders.js");
...
/* harmony import */ var _components_lazyloading_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/lazyloading.js */ "./src/js/components/lazyloading.js");



$(document).ready(function () {
  _components_lazyloading_js__WEBPACK_IMPORTED_MODULE_2__["default"].init();
  _components_scriptloaders_js__WEBPACK_IMPORTED_MODULE_0__["default"].init();
  _components_mobile_menu_js__WEBPACK_IMPORTED_MODULE_1__["default"].init();
});
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _libs_mmenu_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../libs/mmenu.js */ "./src/js/libs/mmenu.js");
/* harmony import */ var _libs_mmenu_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_libs_mmenu_js__WEBPACK_IMPORTED_MODULE_0__);
...
/***/ "./src/js/components/scriptloaders.js":
/*!********************************************!*\
  !*** ./src/js/components/scriptloaders.js ***!
  \********************************************/
/*! exports provided: default */
...
(function (root, factory) {
    ...
    r[t].addons[p] = {
      setup: function setup() {
        if (this.opts[p]) {
          var e = this.opts[p],
              i = this.conf[p];
          a = r[t].glbl, this._api = r.merge(this._api, ["open", "close", "setPage"]), "object" != _typeof(e) && (e = {}), e = this.opts[p] = r.extend(!0, {}, r[t].defaults[p], e), "string" != typeof i.page.selector && (i.page.selector = "> " + i.page.nodetype), this.vars.opened = !1;
    ...
    s[e].addons[i] = {
      setup: function setup() {
        ...
        if (s[e].glbl, "boolean" == typeof h && h && (h = {
          ...
          height: h
        }), "object" != _typeof(h) && (h = {}), "auto" == (h = this.opts[i] = s.extend(!0, {}, s[e].defaults[i], h)).height || "highest" == h.height) {
          this.bind("initMenu:after", function () {
          ...
          var t = function t(_t) {
            if (!this.opts.offCanvas || this.vars.opened) {
              var e = Math.max(parseInt(this.$pnls.css("top"), 10), 0) || 0,
                  ...
                  n = 0;
              this.$menu.addClass(a.menu + "_autoheight-measuring"), "auto" == h.height ? ((_t = _t || this.$pnls.children("." + a.panel + "_opened")).parent("." + a.listitem + "_vertical").length && (_t = _t.parents("." + a.panel).not(function () {
                return s(this).parent("." + a.listitem + "_vertical").length;
              })), _t.length || (_t = this.$pnls.children("." + a.panel)), n = _t.first().outerHeight()) : "highest" == h.height && this.$pnls.children("." + a.panel).each(function () {
                var t = s(this);
  ...
  !function (s) {
    ...
    s[h].addons[c] = {
      setup: function setup() {
        if (this.opts.offCanvas) {
          ...
          s[h].glbl, "boolean" == typeof n && (n = {
            close: n
          }), "object" != _typeof(n) && (n = {}), n = s.extend(!0, {}, s[h].defaults[c], n);
      ...
      clickAnchor: function clickAnchor(n, t) {}
    }, s[h].defaults[c] = {
      close: !1,
      open: !1
    };
    ...
    t[n].addons[p] = {
      setup: function setup() {
        ...
        if (t[n].glbl, "boolean" == typeof i && (i = {
          ...
          add: !0,
          visible: i
        }), "object" != _typeof(i) && (i = {}), "number" == typeof i.visible && (i.visible = {
          min: i.visible,
          max: i.visible
    ...
    a[n].addons[c] = {
      setup: function setup() {
        ...
        if (a[n].glbl, "boolean" == typeof e && (e = {
          add: e,
          update: e
        }), "object" != _typeof(e) && (e = {}), e = this.opts[c] = a.extend(!0, {}, a[n].defaults[c], e), this.bind("initListview:after", function (t) {
          ...
          var t = function t(_t2) {
            (_t2 = _t2 || this.$pnls.children("." + s.panel)).each(function () {
              var t = a(this),
                  n = t.data(d.parent);
      ...
      clickAnchor: function clickAnchor(t, n) {}
    }, a[n].defaults[c] = {
      add: !1,
      addTo: "panels",
      count: !1
    ...
    d[t].addons[a] = {
      setup: function setup() {
        ...
        if (d[t].glbl, "boolean" == typeof n && (n = {
          add: n,
          fixed: n
        }), "object" != _typeof(n) && (n = {}), (n = this.opts[a] = d.extend(!0, {}, d[t].defaults[a], n)).type && this.bind("initMenu:after", function () {
      ...
      clickAnchor: function clickAnchor(i, t) {}
    }, d[t].defaults[a] = {
      add: !1,
      addTo: "panels",
      fixed: !1,
  ...
  !function (y) {
    ...
    y[n].addons[O] = {
      setup: function setup() {
        if (this.opts.offCanvas) {
          ...
          o = y[n].glbl, "boolean" == typeof e && (e = {
            menu: e,
            panels: e
          }), "object" != _typeof(e) && (e = {}), "boolean" == typeof e.menu && (e.menu = {
            open: e.menu
          }), "object" != _typeof(e.menu) && (e.menu = {}), "boolean" == typeof e.panels && (e.panels = {
            close: e.panels
          }), "object" != _typeof(e.panels) && (e.panels = {}), (e = this.opts[O] = y.extend(!0, {}, y[n].defaults[O], e)).menu.open && this.bind("setPage:after", function () {
            (function (e, t, o) {
              var i,
                  a,
                  s,
      ...
      clickAnchor: function clickAnchor(n, e) {}
    }, y[n].defaults[O] = {
      menu: {
        open: !1,
        maxStartPos: 100,
  ...
  !function (n) {
    ...
    n[t].addons[f] = {
      setup: function setup() {
        if (this.opts.offCanvas) {
          ...
          if (y = n[t].glbl, "boolean" == typeof x && x && (x = {
            drop: x
          }), "object" != _typeof(x) && (x = {}), "string" == typeof x.position && (x.position = {
            of: x.position
      ...
      clickAnchor: function clickAnchor(t, o) {}
    }, n[t].defaults[f] = {
      drop: !1,
      fitViewport: !0,
      event: "click",
  ...
  !function (c) {
    ...
    c[n].addons[t] = {
      ...
      clickAnchor: function clickAnchor(a, n) {}
    }, c[n].defaults[t] = {
      add: !1,
      top: [],
      bottom: []
    ...
    s[r].addons[o] = {
      setup: function setup() {
        ...
        s[r].glbl, "boolean" == typeof a && (a = {
          ...
          add: !0,
          visible: a
        }), "object" != _typeof(a) && (a = {}), "first" == a.visible && (t = !0, a.visible = 1), (a = this.opts[o] = s.extend(!0, {}, s[r].defaults[o], a)).visible = Math.min(3, Math.max(1, a.visible)), a.visible++;
        var l = "";
      ...
      clickAnchor: function clickAnchor(e, i) {}
    }, s[r].defaults[o] = {
      add: !1,
      blockPanel: !0,
      hideDivider: !1,
      ...
      setup: function setup() {
        if (!s[r].support.touch) {
          ...
          if (i = s[r].glbl, "boolean" != typeof e && "string" != typeof e || (e = {
            enable: e
          }), "object" != _typeof(e) && (e = {}), (e = this.opts[c] = s.extend(!0, {}, s[r].defaults[c], e)).enable) {
    ...
    e[l].addons[t] = {
      setup: function setup() {
        ...
        e[l].glbl, "boolean" == typeof n && (n = {
          load: n
        }), "object" != _typeof(n) && (n = {}), (n = this.opts[t] = e.extend(!0, {}, e[l].defaults[t], n)).load && (this.bind("initMenu:after", function () {
      ...
      setup: function setup() {
        ...
        if (b[h].glbl, void 0 !== l) {
          ...
          l.length && (b.each(l, function (n) {
            var t = l[n];
            "boolean" == typeof t && t && (t = {}), "object" != _typeof(t) && (t = {}), void 0 === t.content && (t.content = ["prev", "title"]), t.content instanceof Array || (t.content = [t.content]), t = b.extend(!0, {}, d.opts.navbar, t);
  ...
  !function (f) {
    ...
    f[c].addons[d] = {
      ...
      clickAnchor: function clickAnchor(t, e, i) {
    ...
    o[n].addons[_] = {
      setup: function setup() {
        ...
        o[n].glbl, "boolean" == typeof t && (t = {
          ...
          add: t.panel
        }), "object" != _typeof(t.panel) && (t.panel = {}), t.add && ("panel" == t.addTo && (t.panel.add = !0), t.panel.add && (t.showSubPanels = !1, t.panel.splash && (t.cancel = !0)), t = this.opts[_] = o.extend(!0, {}, o[n].defaults[_], t), e = this.conf[_] = o.extend(!0, {}, o[n].configuration[_], e), this.bind("close:start", function () {
    ...
    d[e].addons[o] = {
      setup: function setup() {
        ...
        d[e].glbl, "boolean" == typeof i && (i = {
          add: i
        }), "object" != _typeof(i) && (i = {}), i = this.opts[o] = d.extend(!0, {}, d[e].defaults[o], i);
        var r = null;
        this.bind("initPanels:after", function (e) {
          if (i.add) {
            var a;
    ...
    t[l].addons[r] = {
      setup: function setup() {
        ...
        if (t[l].glbl, "boolean" == typeof e && (e = {
          hover: e,
          parent: e
        }), "object" != _typeof(e) && (e = {}), "detect" == (e = this.opts[r] = t.extend(!0, {}, t[l].defaults[r], e)).current) {
          var i = function i(e) {
            e = e.split("?")[0].split("#")[0];
  ...
  !function (a) {
    ...
    a[l].addons[i] = {
      setup: function setup() {
        if (this.opts.offCanvas) {
          ...
          t = a[l].glbl, ("string" == typeof e || "boolean" == typeof e && e || "number" == typeof e) && (e = {
            expanded: e
          }), "object" != _typeof(e) && (e = {}), "boolean" == typeof e.collapsed && e.collapsed && (e.collapsed = "all"), "string" != typeof e.collapsed && "number" != typeof e.collapsed || (e.collapsed = {
            use: e.collapsed
          }), "object" != _typeof(e.collapsed) && (e.collapsed = {}), "number" == typeof e.collapsed.use && (e.collapsed.use = "(min-width: " + e.collapsed.use + "px)"), "boolean" == typeof e.expanded && e.expanded && (e.expanded = "all"), "string" != typeof e.expanded && "number" != typeof e.expanded || (e.expanded = {
            use: e.expanded
          }), "object" != _typeof(e.expanded) && (e.expanded = {}), "number" == typeof e.expanded.use && (e.expanded.use = "(min-width: " + e.expanded.use + "px)"), e = this.opts[i] = a.extend(!0, {}, a[l].defaults[i], e);
      ...
      clickAnchor: function clickAnchor(e, d, s) {
  ...
  !function (t) {
    ...
    t[a].addons.navbars.searchfield = function (s, e) {
      t[a]._c;
      "object" != _typeof(this.opts.searchfield) && (this.opts.searchfield = {}), this.opts.searchfield.add = !0, this.opts.searchfield.addTo = s;
    };
  }(jQuery);
  !function (i) {
    var o = "mmenu",
  ...
  jQuery.mmenu.i18n({
    Menu: "MenÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼"
  }, "de");
  jQuery.mmenu.i18n({
    "Close menu": "MenÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼ schlieÃƒÆ’Ã†â€™Ãƒâ€¦Ã‚Â¸en",
    "Close submenu": "UntermenÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼ schlieÃƒÆ’Ã†â€™Ãƒâ€¦Ã‚Â¸en",
    "Open submenu": "UntermenÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼ ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¶ffnen",
    "Toggle submenu": "UntermenÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¼ wechseln"
  }, "de");
  jQuery.mmenu.i18n({
    Search: "Suche",
  ...
  jQuery.mmenu.i18n({
    Menu: "ÃƒÆ’Ã‚ÂÃƒâ€¦Ã¢â‚¬Å“ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â½ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã‚Â½"
  }, "ru");
  jQuery.mmenu.i18n({
    "Close menu": "ÃƒÆ’Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬ÂÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â°ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂºÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¹ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã¢â‚¬â„¢ ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¼ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â½ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã‚Â½",
    "Close submenu": "ÃƒÆ’Ã‚ÂÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬ÂÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â°ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂºÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¹ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã¢â‚¬â„¢ ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¿ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¾ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â´ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¼ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â½ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã‚Â½",
    "Open submenu": "ÃƒÆ’Ã‚ÂÃƒâ€¦Ã‚Â¾ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂºÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¹ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã¢â‚¬â„¢ ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¿ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¾ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â´ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¼ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â½ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã‚Â½",
    "Toggle submenu": "ÃƒÆ’Ã‚ÂÃƒâ€¦Ã‚Â¸ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â‚¬Å¡Ã‚Â¬ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂºÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â»ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã‚Â½ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¸ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã¢â‚¬â„¢ ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¿ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¾ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â´ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¼ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â½ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã‚Â½"
  }, "ru");
  jQuery.mmenu.i18n({
    Search: "ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â°ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¹ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¸",
    "No results found.": "ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¸ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¡ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â³ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¾ ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â½ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Âµ ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â½ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â°ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¹ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â´ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â½ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¾.",
    "Search results": "ÃƒÆ’Ã‚Â ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂµÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â·ÃƒÆ’Ã¢â‚¬ËœÃƒâ€ Ã¢â‚¬â„¢ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â»ÃƒÆ’Ã¢â‚¬ËœÃƒâ€¦Ã¢â‚¬â„¢ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â°ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã…Â¡ÃƒÆ’Ã¢â‚¬ËœÃƒÂ¢Ã¢â€šÂ¬Ã‚Â¹ ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¿ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¾ÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â¸ÃƒÆ’Ã¢â‚¬ËœÃƒâ€šÃ‚ÂÃƒÆ’Ã‚ÂÃƒâ€šÃ‚ÂºÃƒÆ’Ã‚ÂÃƒâ€šÃ‚Â°"
  }, "ru");
  return true;
});
...
__webpack_require__(/*! /Users/saskia/Documents/repos/websites/blog/wp-content/themes/vanaf1979/src/js/app.js */"./src/js/app.js");
module.exports = __webpack_require__(/*! /Users/saskia/Documents/repos/websites/blog/wp-content/themes/vanaf1979/src/css/app.scss */"./src/css/app.scss");
